...
# ACDS 18.0 614 win32 2018.11.28.21:20:53
# ----------------------------------------
...
# ----------------------------------------
# If Clock_1200kHz is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "Clock_1200kHz"
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/Clock_1200kHz.vo"
}
